...
namespace Restaurant.Entitys
{
    ...
    {
        public Bestellung(int bestellNr, int rechnungNr,int TischNr ,KartenElement kartenElement, int kartenElementNr, string hinweise, DateTime AufgebenAm, bool erledigt,int GaesteNr)
        {
            BestellNr = bestellNr;
